...
- [Реализация игровых обьектов: "юниты", "строения", "пули" и их физическое преставление](#game-objects)
...
ИИ - основан на конечном автомате, с бинарным графом. Ребра графа - проверки, вершины графа - действие бота (состояние).
...
Юнит запрашивает поиск пути если ему надо 1 раз в ИИ тик (1 сек)
